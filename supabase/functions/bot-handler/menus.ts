...
export function buildKeyboard(isFR: boolean) {
  ...
  return {
    keyboard: [
      [L('coop')],
      [L('tamagotchi'), L('eggclicker')],
      [L('chickenblast'), L('eggsponential')],
      [L('mastermind'), L('chickenmemory')],
      [L('chickenfight'), L('chickenreflex')],
      [L('snake'), L('chickensolitaire')],
      [L('chickenmine'), L('sudoku')],
      [L('motus'), L('chickenhang')],
      [L('francrun'), L('ormuz')],
      [L('wordsearch')],
      [L('refresh'),    L('rules')],
      [L('holders')],
...
export function buildInlineMenu(isFR: boolean) {
  ...
  return { inline_keyboard: [
    ...
    [{ text: L('tamagotchi'), url: TAMAGOTCHI_URL }, { text: L('eggclicker'), url: EGGCLICKER_URL }],
    [{ text: L('chickenblast'), url: CHICKENBLAST_URL }, { text: L('eggsponential'), url: EGGSPONENTIAL_URL }],
    [{ text: L('mastermind'), url: MASTERMIND_URL }, { text: L('chickenmemory'), url: CHICKENMEMORY_URL }],
    [{ text: L('chickenfight'), url: CHICKENFIGHT_URL }, { text: L('chickenreflex'), url: CHICKENREFLEX_URL }],
    [{ text: L('snake'), url: SNAKE_URL }, { text: L('chickensolitaire'), url: SOLITAIRE_URL }],
    [{ text: L('chickenmine'), url: CHICKENMINE_URL }, { text: L('sudoku'), url: SUDOKU_URL }],
    [{ text: L('motus'), url: MOTUS_URL }, { text: L('chickenhang'), url: CHICKENHANG_URL }],
